...
Robot modifyByValue(Robot rob) {
    rob.setName("Roberta");
    rob.setBatteryLife(0);
    return rob;
}

// Step 3: Function to modify robot (pass by reference)
void modifyByReference(Robot& rob) {
    rob.setName("Robbie");
    rob.setBatteryLife(100);
}
